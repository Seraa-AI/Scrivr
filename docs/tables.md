...
Tables are the most complex block type in Inscribe. They require:
...
The 4 node types map directly to Inscribe's schema. Define them manually (or call `tableNodes()`) with these specs:
