...
describe("CharacterMap", () => {
  ...
  describe("posAtCoords", () => {
    ...
    it("falls back to adjacent page when clicking on a page with no lines", () => {
      // Page 2 has no lines. With cross-page fallback, posAtCoords returns
      // the nearest line's boundary docPos from an adjacent page (page 1).
  ...
  describe("clearPage", () => {
    it("removes glyphs and lines for the specified page only", () => {
      ...
      // Page 2 glyphs/lines are gone — falls back to adjacent page
