...
See [Event Callbacks](/docs/api/events) for full documentation of each callback.
...
See [Custom Extensions](/docs/guides/nodes/custom-extensions) for full documentation.
